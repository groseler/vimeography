<?php
/*
Plugin Name: Vimeography Theme: VideoPartnerTheme
Plugin URI: #
Theme Name: VideoPartnerTheme
Theme URI: #
Version: 1.0
Description: #
Author: D#
...
if ( ! class_exists('Vimeography_Themes_VideoPartnerTheme') ) {
  class Vimeography_Themes_VideoPartnerTheme {
    /**
    ...
    public static function load_scripts() {
      ...
      wp_register_style('videopartnertheme', plugins_url('assets/css/videopartnertheme.css', __FILE__));
      ...
      wp_enqueue_style('videopartnertheme');
    }
  ...
  new Vimeography_Themes_VideoPartnerTheme;
}

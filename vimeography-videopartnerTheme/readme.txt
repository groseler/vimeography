...
videopartnertheme is the base theme that comes prepackaged with Vimeography.
...
1. Upload `vimeography-videopartnertheme.zip` to the `/wp-content/plugins/` directory
